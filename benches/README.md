...
|Description                |  Plot                    |
|:-------------------------:|:-------------------------:
|PDF (Times) | <img src="https://github.com/IteraLabs/atelier/blob/main/assets/images/benches/orderbook_generation/b_l_100_b_o_Some((1000%2C%201300))_a_l_100_a_o_Some((1000%2C%201300))_1.png" width = "600" height = "450"> |
