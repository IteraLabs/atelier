    ...
    for i_variant in vec_variants {
        ...
        match i_variant {
            ...
            EventType::NewMarketOrder => {
                single_queue
                    .push(templates::random_new_mo_template()
                    .unwrap());
            },
            
            EventType::CancelLimitOrder => {
                single_queue
                    .push(templates::random_cancel_lo_template()
                    .unwrap());
            },
            
            EventType::NewLimitOrder => {
                single_queue
                    .push(templates::random_new_lo_template()
                    .unwrap());
            },
            
            EventType::ModifyLimitOrder => {
                single_queue
                    .push(templates::random_modify_lo_template()
                    .unwrap());
            }
        }
    }
